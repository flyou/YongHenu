package com.flyou.simplehenu.ui.fragment.main;
 ...
 * ============================================================
 **/
public class EduMessageFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
